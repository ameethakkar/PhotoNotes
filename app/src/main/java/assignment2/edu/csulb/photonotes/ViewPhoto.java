...
public class ViewPhoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mContentView = (ImageView) findViewById(R.id.imageViewContent);
        Log.d("View Photo: ", "Image Path to draw: " + imageInfo.getString("path"));
        Drawable bitmap = Drawable.createFromPath(imageInfo.getString("path"));
        mContentView.setImageDrawable(bitmap);
       ...
       // findViewById(R.id.caption_textView).setOnTouchListener(mDelayHideTouchListener);
        ...
        String imageCaption = imageInfo.getString("caption");
        textViewCaption.setText(imageCaption);
        Log.d("ViewPhoto", "Image Caption " + imageCaption);
    }
